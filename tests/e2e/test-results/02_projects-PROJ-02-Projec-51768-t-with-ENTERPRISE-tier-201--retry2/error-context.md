...
- Name: 02_projects.test.js >> PROJ-02: Project API Module — Black-Box Functional Tests >> PROJ-02: Should create project with ENTERPRISE tier (201)
- Location: 02_projects.test.js:27:3

# Error details

```
Error: registerAndLogin failed after 3 attempts for role=UCTO_ADMIN
```
