...
- Name: 12_concurrency.test.js >> CON-12: Concurrency & Edge Cases — Black-Box Functional Tests >> CON-01: Should handle rapid sequential project creation (no data corruption)
- Location: 12_concurrency.test.js:9:3

# Error details

```
Error: registerAndLogin failed after 3 attempts for role=DEVELOPER
```
