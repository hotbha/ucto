...
- Name: 01_auth.test.js >> AUTH-01: Auth API Module — Black-Box Functional Tests >> AUTH-16: Should reject OTP verify with invalid code (400)
- Location: 01_auth.test.js:143:3
