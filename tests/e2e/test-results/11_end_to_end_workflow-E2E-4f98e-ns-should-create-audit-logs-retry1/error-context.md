...
- Name: 11_end_to_end_workflow.test.js >> E2E-11: End-to-End User Journeys — Black-Box Functional Tests >> E2E-06: Audit trail integrity: project actions should create audit logs
- Location: 11_end_to_end_workflow.test.js:157:3

# Error details

```
Error: registerAndLogin failed after 3 attempts for role=FOUNDER
```
